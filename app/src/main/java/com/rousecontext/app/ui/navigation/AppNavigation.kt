...
private val TAB_ROUTES = setOf(Routes.HOME, Routes.AUDIT, Routes.SETTINGS)
...
fun AppNavigation(
    ...
    val title = when (currentRoute) {
        Routes.HOME -> "Rouse Context"
        Routes.AUDIT -> "Audit History"
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(Routes.ONBOARDING) {
                ...
                // Navigate to Home as soon as onboarding triggers (immediate)
                ...
                when (state) {
                    ...
                    is OnboardingState.Failed -> {
                        // Transient: LaunchedEffect above navigates to Home.
                        // Show nothing while the navigation is in flight.
                    }
                }
            }
            ...
            composable(
                ...
                HomeDashboardContent(
                    ...
                    onIntegrationClick = { id ->
                        navController.navigate(Routes.integrationManage(id))
                    },
                    onViewAllActivity = {
                        navController.navigate(Routes.AUDIT)
                    },
            ...
            composable(
                ...
                val auditDao: com.rousecontext.notifications
                    .audit.AuditDao = org.koin.compose.koinInject()
